...
QUERY_ROUTE_PROMPT = ChatPromptTemplate.from_messages([("system", _ROUTE_SYSTEM), ("human", _ROUTE_HUMAN)])
...
QUERY_REWRITE_PROMPT = ChatPromptTemplate.from_messages([("system", _REWRITE_SYSTEM), ("human", "{question}")])
...
HYDE_PROMPT = ChatPromptTemplate.from_messages([("system", _HYDE_SYSTEM), ("human", "{question}")])
...
MULTI_QUERY_PROMPT = ChatPromptTemplate.from_messages([("system", _MULTI_QUERY_SYSTEM), ("human", "{question}")])
...
AGENT_PLAN_PROMPT = ChatPromptTemplate.from_messages([("system", _AGENT_PLAN_SYSTEM), ("human", _AGENT_PLAN_HUMAN)])
