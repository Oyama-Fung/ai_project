...
import { deleteDocument, listDocuments, retryDocument, uploadDocument } from "@/client/sdk.gen";
...
const ACCEPTED = '.pdf,.docx,.md,.markdown,.html,.html'
...
export function DocumentPage() {
    ...
    const invalidateList = () => queryClient.invalidateQueries({ queryKey: ['documents'] })
